...
namespace OrderBookLib
{
    public class Exchange
    {
        ...
        public Exchange(OrderStore orderStore)
        {
        ...
        public void Bid(string party, decimal priceLimit, int quantity)
        {
            _orderStore.PlaceOrder(party, priceLimit, Side.Bid, quantity);
        }

        public void Ask(string party, decimal priceLimit, int quantity)
        {
